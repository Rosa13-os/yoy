		...
		<div class="col-12">
			<div class="card">
				<div class="modal-header">
					<form class="form-horizontal" method="post"  action="<?php echo site_url('kasubag/Disposisi');?>">
								...
								<tbody id="isi">
									...
									<tr>
										...
										<td>
											...
											<a href="<?php echo base_url('kasubag/detaildisposisi/'.$key->id_disposisi) ?>" class="btn btn-outline-primary" data-toggle="tooltip" title="Detail Disposisi"><i class="fa fa-search"></i></a>
											<a href="<?php echo base_url('kasubag/del_disposisi/'.$key->id_disposisi) ?>" class="btn btn-outline-danger" data-toggle="tooltip" onclick="return confirm('Hapus Disposisi?')" title="Hapus Disposisi"><i class="fa fa-trash"></i></a>
