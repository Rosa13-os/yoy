		...
		<div class="col-12">
			<div class="card">
				<div class="modal-header">
					<form class="form-horizontal" method="post"  action="<?php echo site_url('kasubag/daftardisposisi');?>">
							<button type="submit"  class="btn btn-success" ><i class="glyphicon glyphicon-search"></i> Lihat Daftar Disposisi</button>
					</form>
					<br>
					<form class="form-horizontal" method="post"  action="<?php echo site_url('kasubag/monitoring_disposisi');?>">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<option value="">Pilih Kepada</option>
												...
												<option value="Bag.Perkapalan">Bag.Perkapalan</option>
...
<script type="text/javascript">
	...
	function autofill(){
		$.ajax({
			url : "<?php echo site_url('kasubag/getsuratmasuk');?>",
			type : "POST",
			dataType : "json",
			data : {
				nomer : $("#no_surat").val()
