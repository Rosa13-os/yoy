<?php 
$admin = $this->db->where('id_pegawai',$this->session->userdata('operator'))->get('pegawai')->result();
  ...
  <div class="main-menu-content">
    ...
    <li class=" nav-item"><a href="#"><i class="fa fa-envelope"></i><span data-i18n="nav.advance_cards.main" class="menu-title">Arsip Surat</spanent></a>
        <ul class="menu-cont">
          ...
          <li><a href="<?php echo base_url('operator/suratkeluar') ?>" data-i18n="nav.cards.keluar" class="menu-item">Surat Keluar</a>
          </li>
        </ul>
      </li>
      ...
      <li class=" nav-item"><a href="<?php echo base_url('operator/disposisi') ?>"><i class="fa fa-envelope-open"></i><span data-i18n="nav.dash.main" class="menu-title">Disposisi Surat</span></a>
      </li>
      ...
      <script>
        function cek() {
          if ($("#lama").val()!=='') {
            $.ajax({
              type: "GET",
              url: "<?php echo base_url('operator/carilama/') ?>"+$("#lama").val(),
        ...
        function cekusername() {
          if ($("#user").val()!=='') {
            $.ajax({
              type: "GET",
              url: "<?php echo base_url('operator/cariusername/') ?>"+$("#user").val(),
              success: function (data) {
                var dataa = data;
                if (dataa==1) {
