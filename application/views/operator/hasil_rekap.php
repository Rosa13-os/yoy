		...
		<div class="col-12">
			<div class="card">
				<div class="card-block">
					...
					<br>
					<div class="form-group">
						<button class="btn btn-outline-warning" onclick="ditujukan()"><i class="fa fa-print"></i> Print Rekapitulasi</button>
						<a href="<?php echo site_url('operator/cetak_export/');?><?php echo $this->input->post('dari');?>/<?php echo $this->input->post('sampai');?>" target="_blank" class="btn btn-outline-success"><i class="fa fa-download"></i> Export Excel</a>
					</div>
					<table class="table">
						<tr>
							<td>No</td>
					...
					<div class="col-md-12">
						<center>
							<table style="width: 100%" class="table table-striped">
								...
								?>
								<tr>
									<td><center><h4>Rekapitulasi Data Surat Kecamatan Dayeuhkolot <br> <?php echo $dt_dari->format('d M Y').' - '.$dt_sampai->format('d M Y') ?></h4></center></td>
								</tr>
							</table>
							<hr>
						</center>
