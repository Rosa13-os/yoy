		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body " style="padding: 20px;">
					...
					<div class="row">
						<form action="<?php echo base_url('kepala/add_disposisi') ?>" method="post">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<a href="<?php echo base_url('kepala/disposisi') ?>" class="btn btn-outline-danger">Batal</a>
								</div>
							</div>
...
<script type="text/javascript">
	...
	function autofill(){
		$.ajax({
			url : "<?php echo site_url('kepala/getsuratmasuk');?>",
			type : "POST",
			dataType : "json",
			data : {
				nomer : $("#no_surat").val()
