		...
		<div class="col-12">
			<div class="card">
				<div class="card-block">
					...
					<br>
					<div class="form-group">
						<button class="btn btn-outline-warning" onclick="disposisi()"><i class="fa fa-print"></i> Print Rekapitulasi</button>
					</div>
					<table class="table">
						<tr>
							<td>No</td>
		...
		<div class="card-body card-block">
			<div class="row">
				<table class="table" border="0">
					<tr>
						<td><img src="<?php echo base_url('assets/logo2.png') ?>" alt=""></td>
						<td>
							<center>
				...
				<div class="col-md-12">
					...
					<div class="col-md-12">
						...
						<table class="table" border="1" width="100%">
							...
							<?php $no = 0; foreach ($suratmasuk->result() as $key): $no++;?>
							<tr>
								<td><?php echo $no ?></td>
					...
					<table class="table" border="1" width="100%">
						...
						<?php $no = 0; foreach ($suratkeluar->result() as $key): $no++;?>
						<tr>
							<td><?php echo $no ?></td>
							<td><?php echo $key->no_surat ?></td>
							<td><?php echo $key->kode_surat ?></td>
