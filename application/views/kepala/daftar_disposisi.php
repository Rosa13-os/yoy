		...
		<div class="col-12">
			<div class="card">
				<div class="modal-header">
					<form class="form-horizontal" method="post"  action="<?php echo site_url('kepala/Disposisi');?>">
							<button type="submit"  class="btn btn-success" ><i class="glyphicon glyphicon-search"></i> Tambah Disposisi</button>
					</form>
							...
							<table cellspacing="0" class="display nowrap table table-hover table-striped table-bordered tableku" width="100%">
								...
								<tbody id="isi">
									...
									<tr>
										...
										<td>
											<button class="btn btn-outline-success" data-toggle="modal" data-target="#update<?php echo $key->id_disposisi ?>"><i data-toggle="tooltip" title="Update Disposisi" class="fa fa-edit"></i></button>
											<a href="<?php echo base_url('Kepala/detaildisposisi/'.$key->id_disposisi) ?>" class="btn btn-outline-primary" data-toggle="tooltip" title="Detail Disposisi"><i class="fa fa-search"></i></a>
											<a href="<?php echo base_url('Kepala/del_disposisi/'.$key->id_disposisi) ?>" class="btn btn-outline-danger" data-toggle="tooltip" onclick="return confirm('Hapus Disposisi?')" title="Hapus Disposisi"><i class="fa fa-trash"></i></a>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel1">Edit Disposisi</h4>
			</div>
			<form method="post" action="<?php echo base_url('kepala/update_disposisi/'.$e->id_disposisi) ?>" enctype="multipart/form-data">
